...
export const metadata: Metadata = {
  ...
  description:
    "Latest articles on generative AI, LLMs, and creative AI applications",
};
  ...
  return (
    <div>
      ...
      <p className="text-lg text-gray-600 mb-8">
        Explore the cutting-edge world of generative AI, from language models to
        image generation.
      </p>
      ...
      {posts.length > 0 ? (
        ...
        <div className="text-center py-12">
          <p className="text-gray-600 text-lg">
            No posts found. Please add content in Contentstack CMS.
          </p>
        </div>
      )}
